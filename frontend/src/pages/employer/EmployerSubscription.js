...
const FREE_PLAN = {
  ...
  Price: 0,
  DurationInDays: 0,
  Features: `Đẩy top bài tuyển dụng ${APP_CONSTANTS.FREE_LIMITS.EMPLOYER.PUSH_TOP_WEEKLY} lần/tuần
  Đăng tối đa ${APP_CONSTANTS.FREE_LIMITS.EMPLOYER.POST_JOB_DAILY} bài viết/ngày`,
